...
for (let i = 0; i < certificatesItem.length; i++) {
  ...
  certificatesItem[i].addEventListener("click", function () {
    ...
    modalImg.src = this.querySelector("[data-certificates-img]").src;
    modalImg.alt = this.querySelector("[data-certificates-img]").alt;
    modalLink.href = this.querySelector("[data-certificates-title]").href;
